...
public class JdbcCrudMainConLoadSuSelectAddSuInsert {
	...
	public static void main(String[] args) {
		...
		try {																	//prova ad eseguire le istruzioni interne al blocco try-catch
			...
			//algoritmo che seleziona il record � trasferito nel metodo loadClienteByPrimaryKey
		    ...
		    List<Cliente> elencoClienti = loadClienteByNominativo(jdbcConnectionToDatabase, "%Pers%");            
		    ...
		    Cliente clienteToInsert = new Cliente("RGNSFA0123456789", "Romagnolo Sofia");
		    
		    addCliente(jdbcConnectionToDatabase, clienteToInsert);
...
//	Premessa: rendere i metodi di seguito indicati con modificatore 'static'
//	cosicchè da rendereli richiamabili dal main
//	1) implementare il metodo loadClienteByNominativo richiamabile dal main
//	2) implementare il metodo addCliente richiamabile dal main

	//Metodo di Select richiamabile nel Main
	public static List<Cliente> loadClienteByNominativo(Connection jdbcConnectionToDatabase, String parametroNominativo)throws SQLException{
	...
	//Metodo di insert richiamato nel Main
	public static void addCliente(Connection jdbcConnectionToDatabase, Cliente cliente)throws SQLException {
    	...
    	System.out.println("Cliente inserito=> " + cliente.toString());
	}
}
